USE [master]
GO
DROP DATABASE TrabajoGI2425
GO
CREATE DATABASE TrabajoGI2425
GO
USE [TrabajoGI2425]
GO
/****** Object:  Table [dbo].[tPermiso]     ******/
SET ANSI_NULLS ON
GO
